...
export type Linear = typeof(setmetatable({} :: LinearProperties & Spline.Spline, Linear))
...
function Linear.sampleTanget(self: Linear, t: number): Transform.Position
	...
	return self.positions[2] - self.positions[1] :: any
end
...
function Linear.sampleRotation(self: Linear, t: number): Transform.Rotation
	...
	error("Rotation type is neither Angle or Quternion!")
end
...
function Linear.linearInterpolation<T>(val1: T, val2: T, t: number): T
	...
	return (1 - t) * val1 :: any + t * val2 :: any
end
