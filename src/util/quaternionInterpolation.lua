...
local bernsteinPolynomialUtil = require("./bernsteinPolynomialUtil")
...
function quaternionInterpolation.barryGoldman(q0: Quaternion.Quaternion, q1: Quaternion.Quaternion, q2: Quaternion.Quaternion, q3: Quaternion.Quaternion, t: number): Quaternion.Quaternion
	local t0 = t + 1
...
function quaternionInterpolation.fastBarryGoldman(q0: Quaternion.Quaternion, q1: Quaternion.Quaternion, q2: Quaternion.Quaternion, q3: Quaternion.Quaternion, t: number): Quaternion.Quaternion
	local t0 = t + 1
...
function quaternionInterpolation.cumulative(quaternions: {Quaternion.Quaternion}, weights: {number}, t: number): Quaternion.Quaternion
...
function quaternionInterpolation.getControlQuaternions(quaternions: {Quaternion.Quaternion}, tension: number, continuity: number, bias: number, t: number): {Quaternion.Quaternion}
...
function quaternionInterpolation.getShoemakeControlQuaternions(quaternions: {Quaternion.Quaternion}): {Quaternion.Quaternion}
	local a = quaternionInterpolation.bisect(quaternionInterpolation.double(quaternions[1], quaternions[2]) * quaternions[3])
