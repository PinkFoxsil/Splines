...
function SplineService.viewSpline(spline: Spline.Spline, partAmount: number?, properties: {color: Color3?, transparency: number?, thickness: number?}?): SplineVisual.SplineVisual
...
function SplineService.viewSplineTPositions(spline: Spline.Spline, partAmount: number?, properties: {color: Color3?, transparency: number?, diameter: number?}?): SplineVisual.SplineVisual
...
function SplineService.viewSplineDistancePositions(spline: Spline.Spline, sampleAmount: number?, distance: number?, properties: {color: Color3?, transparency: number?, diameter: number?}?): SplineVisual.SplineVisual
...
function SplineService.animateSplineTPositions(spline: Spline.Spline, partAmount: number?, speed: number?, properties: {color: Color3?, transparency: number?, diameter: number?}?): SplineVisual.SplineVisual
...
function SplineService.animateSplineDistancePositions(spline: Spline.Spline, sampleAmount: number?, speed: number?, distance: number?, properties: {color: Color3?, transparency: number?, diameter: number?}?): SplineVisual.SplineVisual
...
function SplineService.viewBoundingBox(spline: Spline.Spline, properties: {color: Color3?, transparency: number?}?): SplineVisual.SplineVisual
